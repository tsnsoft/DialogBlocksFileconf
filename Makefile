...
CC=gcc
RESCOMP=windres.exe
RCFILEOBJ=DialogBlocksFileconf_rc.o
RCFILESRC=DialogBlocksFileconf.rc
RESOURCEOBJECT=
OUTPUTPATH=GCCUnicodeDebug
OBJECTPATH=GCCUnicodeDebug
BUILDPATHS=$(OBJECTPATH)
EXTRADEPENDENCIES=
PROGRAM=DialogBlocksFileconf
...
OBJECTS=$(OBJECTPATH)/Source.o $(RESOURCEOBJECT)
